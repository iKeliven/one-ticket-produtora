...
import {
  ...
  createFilterOptions,
  useTheme
} from "./chunk-453OMCIF.js";
import "./chunk-SYK3JVC3.js";
import "./chunk-U4NZM7B3.js";
import {
  Button_default
} from "./chunk-DAJQT7R5.js";
import {
  Chip_default
} from "./chunk-I6LSCORC.js";
import "./chunk-OJX5UZBG.js";
import {
  alpha,
  darken,
  decomposeColor,
  ...
  toPropertyKey
} from "./chunk-N6C6D46S.js";
import {
  require_react_dom
} from "./chunk-ALHE7CBT.js";
import {
  init_utils as init_utils2,
  useId_default
} from "./chunk-WYSLEPNP.js";
import "./chunk-IKWZAJQS.js";
import "./chunk-T3Z43NVH.js";
import {
  createSvgIcon
} from "./chunk-KQYWTD7V.js";
import "./chunk-KBJX5XJL.js";
import "./chunk-VLIO5GLN.js";
import {
  HTMLElementType,
  _extends,
  ...
  useTimeout
} from "./chunk-JNPNW3SU.js";
import {
  require_jsx_runtime
} from "./chunk-F4W2A6EE.js";
import {
  require_react
} from "./chunk-7CRBLVTW.js";
import {
  __toESM
...
function GridFilterInputValue(props) {
  ...
  const [filterValueState, setFilterValueState] = React9.useState((_a = item.value) != null ? _a : "");
  ...
  React9.useEffect(() => {
    ...
    if (itemPlusTag.fromInput !== id || item.value === void 0) {
      setFilterValueState(String((_a2 = item.value) != null ? _a2 : ""));
    }
  }, [id, item]);
  ...
  }, others, (_b = rootProps.slotProps) == null ? void 0 : _b.baseTextField));
}
...
var shouldQuickFilterExcludeHiddenColumns = (filterModel) => {
  var _a;
  return (_a = filterModel.quickFilterExcludeHiddenColumns) != null ? _a : true;
};
var buildAggregatedQuickFilterApplier = (filterModel, apiRef) => {
  var _a, _b;
  const quickFilterValues = (_b = (_a = filterModel.quickFilterValues) == null ? void 0 : _a.filter(Boolean)) != null ? _b : [];
...
var buildAggregatedFilterApplier = (filterModel, apiRef, disableEval) => {
  ...
  return function isRowMatchingFilters(row, shouldApplyFilter, result) {
    var _a, _b;
    result.passingFilterItems = (_a = isRowMatchingFilterItems == null ? void 0 : isRowMatchingFilterItems(row, shouldApplyFilter)) != null ? _a : null;
    result.passingQuickFilterValues = (_b = isRowMatchingQuickFilter == null ? void 0 : isRowMatchingQuickFilter(row, shouldApplyFilter)) != null ? _b : null;
  };
};
...
var passFilterLogic = (allFilterItemResults, allQuickFilterResults, filterModel, apiRef, cache2) => {
  ...
  if (cleanedFilterItemResults.length > 0) {
    ...
    const logicOperator = (_a = filterModel.logicOperator) != null ? _a : getDefaultGridFilterModel().logicOperator;
  ...
  if (cleanedQuickFilterResults.length > 0 && filterModel.quickFilterValues != null) {
    ...
    const quickFilterLogicOperator = (_b = filterModel.quickFilterLogicOperator) != null ? _b : getDefaultGridFilterModel().quickFilterLogicOperator;
...
var gridPinnedRowsSelector = createSelectorMemoized(gridAdditionalRowGroupsSelector, (additionalRowGroups) => {
  ...
  return {
    bottom: (_b = (_a = rawPinnedRows == null ? void 0 : rawPinnedRows.bottom) == null ? void 0 : _a.map((rowEntry) => {
      var _a2;
      return {
        id: rowEntry.id,
        model: (_a2 = rowEntry.model) != null ? _a2 : {}
      };
    })) != null ? _b : [],
    top: (_d = (_c = rawPinnedRows == null ? void 0 : rawPinnedRows.top) == null ? void 0 : _c.map((rowEntry) => {
      var _a2;
      return {
        id: rowEntry.id,
        model: (_a2 = rowEntry.model) != null ? _a2 : {}
...
var updateCacheWithNewRows = ({
  ...
  const partialUpdates = {
    type: "partial",
    actions: {
      insert: [...(_a = previousCache.updates.actions.insert) != null ? _a : []],
      modify: [...(_b = previousCache.updates.actions.modify) != null ? _b : []],
      remove: [...(_c = previousCache.updates.actions.remove) != null ? _c : []]
    },
...
function GridFilterInputBoolean(props) {
  ...
  const isSelectNative = (_b = baseSelectProps.native) != null ? _b : false;
  const baseSelectOptionProps = ((_c = rootProps.slotProps) == null ? void 0 : _c.baseSelectOption) || {};
  ...
  return (0, import_jsx_runtime8.jsxs)(BooleanOperatorContainer, {
    children: [(0, import_jsx_runtime8.jsxs)(rootProps.slots.baseFormControl, {
      fullWidth: true,
      children: [(0, import_jsx_runtime8.jsx)(rootProps.slots.baseInputLabel, _extends({}, (_d = rootProps.slotProps) == null ? void 0 : _d.baseInputLabel, {
        id: labelId,
        shrink: true,
        variant,
        children: label
...
var useGridNativeEventListener = (apiRef, ref, eventName, handler, options) => {
  ...
  const targetElement = isFunction(ref) ? ref() : (_a = ref == null ? void 0 : ref.current) != null ? _a : null;
...
function GridEditSingleSelectCell(props) {
  ...
  const baseSelectProps = ((_a = rootProps.slotProps) == null ? void 0 : _a.baseSelect) || {};
  const isSelectNative = (_b = baseSelectProps.native) != null ? _b : false;
  const _ref = ((_c = rootProps.slotProps) == null ? void 0 : _c.baseSelect) || {}, {
    MenuProps
...
function GridFilterInputSingleSelect(props) {
  ...
  const filterValue = (_a = item.value) != null ? _a : "";
  const id = useId();
  const labelId = useId();
  const rootProps = useGridRootProps();
  const isSelectNative = (_d = (_c = (_b = rootProps.slotProps) == null ? void 0 : _b.baseSelect) == null ? void 0 : _c.native) != null ? _d : false;
  ...
  return (0, import_jsx_runtime15.jsxs)(SingleSelectOperatorContainer, {
    children: [(0, import_jsx_runtime15.jsxs)(rootProps.slots.baseFormControl, {
      fullWidth: true,
      children: [(0, import_jsx_runtime15.jsx)(rootProps.slots.baseInputLabel, _extends({}, (_e = rootProps.slotProps) == null ? void 0 : _e.baseInputLabel, {
        id: labelId,
        htmlFor: id,
        shrink: true,
        variant,
        ...
        native: isSelectNative,
        notched: variant === "outlined" ? true : void 0
      }, others, (_f = rootProps.slotProps) == null ? void 0 : _f.baseSelect, {
        children: renderSingleSelectOptions({
          ...
          getOptionValue,
          isSelectNative,
          baseSelectOptionProps: (_g = rootProps.slotProps) == null ? void 0 : _g.baseSelectOption
        })
      }))]
    }), clearButton]
  });
...
var gridHeaderFilteringEnabledSelector = createSelector2(
  ...
  (headerFilteringState) => {
    var _a;
    return (_a = headerFilteringState == null ? void 0 : headerFilteringState.enabled) != null ? _a : false;
  }
);
...
var createColumnsState = ({
  ...
  return hydrateColumnsWidth(columnsStateWithPortableColumns, (_c = (_b = (_a = apiRef.current).getRootDimensions) == null ? void 0 : _b.call(_a)) != null ? _c : void 0);
};
...
function getTotalHeaderHeight(apiRef, props) {
  ...
  const filterHeadersHeight = isHeaderFilteringEnabled ? Math.floor(((_a = props.headerFilterHeight) != null ? _a : props.columnHeaderHeight) * densityFactor) : 0;
  return columnHeadersHeight * (1 + (maxDepth != null ? maxDepth : 0)) + filterHeadersHeight;
}
...
var useGridVirtualScroller = () => {
  ...
  const getRows = (params = {}) => {
    ...
    const baseRenderContext = (_a = params.renderContext) != null ? _a : renderContext;
    ...
    const rowModels = (_b = params.rows) != null ? _b : currentPage.rows;
    ...
    const rows = [];
    const rowProps = (_c = rootProps.slotProps) == null ? void 0 : _c.row;
...
function inputsSelector(apiRef, rootProps, enabled, enabledForColumns) {
  ...
  return {
    ...
    lastColumnWidth: (_a = lastColumn == null ? void 0 : lastColumn.computedWidth) != null ? _a : 0,
...
function computeOffsetLeft(columnPositions, renderContext, direction, pinnedLeftLength) {
  ...
  const left = factor * ((_a = columnPositions[renderContext.firstColumnIndex]) != null ? _a : 0) - ((_b = columnPositions[pinnedLeftLength]) != null ? _b : 0);
...
var GridVirtualScrollerRenderZone = React43.forwardRef(function GridVirtualScrollerRenderZone2(props, ref) {
  ...
  const offsetTop = useGridSelector(apiRef, () => {
    ...
    return (_a = rowsMeta.positions[renderContext.firstRowIndex]) != null ? _a : 0;
  });
...
function GridFooterPlaceholder() {
  ...
  return (0, import_jsx_runtime29.jsx)(rootProps.slots.footer, _extends({}, (_a = rootProps.slotProps) == null ? void 0 : _a.footer));
}
...
function findGroupHeaderElementsFromField(elem, field) {
  var _a;
  return Array.from((_a = elem.querySelectorAll(`[data-fields*="|-${escapeOperandAttributeSelector(field)}-|"]`)) != null ? _a : []);
}
...
var GridCell = React48.forwardRef(function GridCell2(props, ref) {
  ...
  const valueToRender = (_b = cellParamsWithAPI.formattedValue) != null ? _b : value;
  const cellRef = React48.useRef(null);
  const handleRef = useForkRef(ref, cellRef);
  const focusElementRef = React48.useRef(null);
  const isSelectionMode = (_c = rootProps.cellSelection) != null ? _c : false;
...
var GridRootStyles = styled_default("div", {
  ...
  const containerBackground = t.vars ? t.vars.palette.background.default : (_b = (_a = t.mixins.MuiDataGrid) == null ? void 0 : _a.containerBackground) != null ? _b : t.palette.background.default;
  const pinnedBackground = (_d = (_c = t.mixins.MuiDataGrid) == null ? void 0 : _c.pinnedBackground) != null ? _d : containerBackground;
...
function GridColumnHeaderItem(props) {
  ...
  const sortingOrder = (_b = colDef.sortingOrder) != null ? _b : rootProps.sortingOrder;
  ...
  const columnTitleIconButtons = (0, import_jsx_runtime42.jsxs)(React60.Fragment, {
    ...
    }, (_c = rootProps.slotProps) == null ? void 0 : _c.columnHeaderFilterIconButton)), showSortIcon && (0, import_jsx_runtime42.jsx)(rootProps.slots.columnHeaderSortIcon, _extends({
      field: colDef.field,
      direction: sortDirection,
      index: sortIndex,
      sortingOrder,
      disabled: !colDef.sortable
    }, (_d = rootProps.slotProps) == null ? void 0 : _d.columnHeaderSortIcon))]
  });
  ...
  const label = (_e = colDef.headerName) != null ? _e : colDef.field;
...
function GridColumnMenuSortItem(props) {
  ...
  const sortingOrder = (_a = colDef.sortingOrder) != null ? _a : rootProps.sortingOrder;
...
var GridFilterForm = React80.forwardRef(function GridFilterForm2(props, ref) {
  ...
  const multiFilterOperator = (_a = filterModel.logicOperator) != null ? _a : GridLogicOperator.And;
  const hasLogicOperatorColumn = hasMultipleFilters && logicOperators.length > 0;
  const baseFormControlProps = ((_b = rootProps.slotProps) == null ? void 0 : _b.baseFormControl) || {};
  const baseSelectProps = ((_c = rootProps.slotProps) == null ? void 0 : _c.baseSelect) || {};
  const isBaseSelectNative = (_d = baseSelectProps.native) != null ? _d : false;
  const baseInputLabelProps = ((_e = rootProps.slotProps) == null ? void 0 : _e.baseInputLabel) || {};
  const baseSelectOptionProps = ((_f = rootProps.slotProps) == null ? void 0 : _f.baseSelectOption) || {};
  const {
    InputComponentProps
    ...
    if (column.type === "singleSelect" && filterValue !== void 0) {
      ...
      if (Array.isArray(filterValue)) {
        filterValue = filterValue.filter((val) => {
          return getValueFromValueOptions(val, valueOptions, colDef == null ? void 0 : colDef.getOptionValue) !== void 0;
        });
  ...
  return (0, import_jsx_runtime61.jsxs)(GridFilterFormRoot, _extends({
    ...
    children: [(0, import_jsx_runtime61.jsx)(FilterFormDeleteIcon, _extends({
      ...
      children: (0, import_jsx_runtime61.jsx)(rootProps.slots.baseIconButton, _extends({
        ...
        size: "small",
        disabled: readOnly
      }, (_g = rootProps.slotProps) == null ? void 0 : _g.baseIconButton, {
      ...
      children: [(0, import_jsx_runtime61.jsx)(rootProps.slots.baseInputLabel, _extends({}, baseInputLabelProps, {
        ...
        native: isBaseSelectNative,
        disabled: readOnly
      }, (_i = rootProps.slotProps) == null ? void 0 : _i.baseSelect, {
      ...
      children: [(0, import_jsx_runtime61.jsx)(rootProps.slots.baseInputLabel, _extends({}, baseInputLabelProps, {
        ...
        disabled: readOnly
      }, (_j = rootProps.slotProps) == null ? void 0 : _j.baseSelect, {
        children: (_k = currentColumn == null ? void 0 : currentColumn.filterOperators) == null ? void 0 : _k.map((operator) => (0, import_react3.createElement)(rootProps.slots.baseSelectOption, _extends({}, baseSelectOptionProps, {
          native: isBaseSelectNative,
          key: operator.value,
...
var GridPreferencesPanel = React91.forwardRef(function GridPreferencesPanel2(props, ref) {
  ...
  const panelContent = apiRef.current.unstable_applyPipeProcessors("preferencePanel", null, (_a = preferencePanelState.openedPanelValue) != null ? _a : GridPreferencePanelsValue.filters);
  ...
  }, (_b = rootProps.slotProps) == null ? void 0 : _b.panel, props, (_c = rootProps.slotProps) == null ? void 0 : _c.basePopper, {
...
var GridPagination = React95.forwardRef(function GridPagination2(props, ref) {
  ...
  if (true) {
    ...
    const pageSize = (_b = (_a = rootProps.paginationModel) == null ? void 0 : _a.pageSize) != null ? _b : paginationModel.pageSize;
...
var GridRow = React98.forwardRef(function GridRow2(props, refProp) {
  ...
  if (minHeight === "auto" && sizes) {
    ...
    const maximumSize = (_a = sizes.baseCenter) != null ? _a : 0;
  ...
  if (typeof rootProps.getRowClassName === "function") {
    const indexRelativeToCurrentPage = index - (((_b = currentPage.range) == null ? void 0 : _b.firstRowIndex) || 0);
  ...
  const getCell = (column, indexInSection, indexRelativeToAllColumns, sectionLength, pinnedPosition = PinnedPosition.NONE) => {
    ...
    const width = (_a2 = cellColSpanInfo == null ? void 0 : cellColSpanInfo.cellProps.width) != null ? _a2 : column.computedWidth;
    const colSpan = (_b2 = cellColSpanInfo == null ? void 0 : cellColSpanInfo.cellProps.colSpan) != null ? _b2 : 1;
    ...
    if ((rowNode == null ? void 0 : rowNode.type) === "skeletonRow") {
      return (0, import_jsx_runtime79.jsx)(slots.skeletonCell, {
        ...
        height: rowHeight,
        field: column.field,
        align: (_c = column.align) != null ? _c : "left"
      }, column.field);
    }
    const editCellState = (_e = (_d = editRowsState[rowId]) == null ? void 0 : _d[column.field]) != null ? _e : null;
...
var useGridStrategyProcessing = (apiRef) => {
  ...
  const getActiveStrategy = React109.useCallback((strategyGroup) => {
    ...
    return (_a = availableStrategyEntry == null ? void 0 : availableStrategyEntry[0]) != null ? _a : GRID_DEFAULT_STRATEGY;
  }, []);
...
var columnsStateInitializer = (state, props, apiRef) => {
  ...
  const columnsState = createColumnsState({
    ...
    columnVisibilityModel: (_e = (_d = props.columnVisibilityModel) != null ? _d : (_c = (_b = props.initialState) == null ? void 0 : _b.columns) == null ? void 0 : _c.columnVisibilityModel) != null ? _e : {},
    keepOnlyColumnsToUpsert: true
  });
  return _extends({}, state, {
    columns: columnsState,
    pinnedColumns: (_f = state.pinnedColumns) != null ? _f : EMPTY_PINNED_COLUMN_FIELDS
  });
};
function useGridColumns(apiRef, props) {
  ...
  const setColumnVisibility = React114.useCallback((field, isVisible) => {
    var _a2;
    const columnVisibilityModel = gridColumnVisibilityModelSelector(apiRef);
    const isCurrentlyVisible = (_a2 = columnVisibilityModel[field]) != null ? _a2 : true;
  ...
  const stateExportPreProcessing = React114.useCallback((prevState, context) => {
    ...
    const shouldExportColumnVisibilityModel = !context.exportOnlyDirtyModels || props.columnVisibilityModel != null || Object.keys((_c = (_b2 = (_a2 = props.initialState) == null ? void 0 : _a2.columns) == null ? void 0 : _b2.columnVisibilityModel) != null ? _c : {}).length > 0 || Object.keys(columnVisibilityModelToExport).length > 0;
...
var densityStateInitializer = (state, props) => {
  var _a, _b, _c;
  return _extends({}, state, {
    density: (_c = (_b = (_a = props.initialState) == null ? void 0 : _a.density) != null ? _b : props.density) != null ? _c : "standard"
  });
};
var useGridDensity = (apiRef, props) => {
  ...
  const stateExportPreProcessing = React115.useCallback((prevState, context) => {
    ...
    const shouldExportRowCount = !context.exportOnlyDirtyModels || props.density != null || ((_a2 = props.initialState) == null ? void 0 : _a2.density) != null;
...
var useGridCsvExport = (apiRef, props) => {
  ...
  const getDataAsCsv = React116.useCallback((options = {}) => {
    ...
    const getRowsToExport = (_a = options.getRowsToExport) != null ? _a : defaultGetRowsToExport;
    ...
    return buildCSV({
      ...
      csvOptions: {
        ...
        shouldAppendQuotes: (_b = options.shouldAppendQuotes) != null ? _b : true,
        includeHeaders: (_c = options.includeHeaders) != null ? _c : true,
        includeColumnGroupsHeaders: (_d = options.includeColumnGroupsHeaders) != null ? _d : true,
        escapeFormulas: (_e = options.escapeFormulas) != null ? _e : true
      },
      ignoreValueFormatter,
      apiRef
    });
...
var getDerivedPaginationModel = (paginationState, signature, paginationModelProp) => {
  ...
  const pageSize = (_a = paginationModelProp == null ? void 0 : paginationModelProp.pageSize) != null ? _a : paginationModel.pageSize;
  const page = (_b = paginationModelProp == null ? void 0 : paginationModelProp.page) != null ? _b : paginationModel.page;
...
var useGridPaginationModel = (apiRef, props) => {
  ...
  const stateExportPreProcessing = React117.useCallback((prevState, context) => {
    ...
    const shouldExportPaginationModel = !context.exportOnlyDirtyModels || props.paginationModel != null || ((_b2 = (_a2 = props.initialState) == null ? void 0 : _a2.pagination) == null ? void 0 : _b2.paginationModel) != null || paginationModel.page !== 0 && paginationModel.pageSize !== defaultPageSize(props.autoPageSize);
...
`;
  ...
  const exportDataAsPrint = React118.useCallback(async (options) => {
    ...
    updateGridRowsForPrint((_a = options == null ? void 0 : options.getRowsToExport) != null ? _a : defaultGetRowsToExport);
    await raf();
...
var filterStateInitializer = (state, props, apiRef) => {
  var _a, _b, _c, _d;
  const filterModel = (_d = (_c = props.filterModel) != null ? _c : (_b = (_a = props.initialState) == null ? void 0 : _a.filter) == null ? void 0 : _b.filterModel) != null ? _d : getDefaultGridFilterModel();
  return _extends({}, state, {
    filter: {
...
var useGridFilter = (apiRef, props) => {
  ...
  const stateExportPreProcessing = React119.useCallback((prevState, context) => {
    ...
    const shouldExportFilterModel = !context.exportOnlyDirtyModels || props.filterModel != null || ((_b2 = (_a2 = props.initialState) == null ? void 0 : _a2.filter) == null ? void 0 : _b2.filterModel) != null || !isDeepEqual(filterModelToExport, getDefaultGridFilterModel());
  ...
  const handleCellKeyDown = React121.useCallback((params, event) => {
    ...
    switch (event.key) {
      ...
      case " ": {
        ...
        if (colDef && colDef.field === "__tree_data_group__") {
          break;
        }
...
var useGridRowCount = (apiRef, props) => {
  ...
  const stateExportPreProcessing = React122.useCallback((prevState, context) => {
    ...
    const shouldExportRowCount = !context.exportOnlyDirtyModels || props.rowCount != null || ((_b2 = (_a2 = props.initialState) == null ? void 0 : _a2.pagination) == null ? void 0 : _b2.rowCount) != null;
    if (!shouldExportRowCount) {
      return prevState;
    }
    return _extends({}, prevState, {
...
var useGridPaginationMeta = (apiRef, props) => {
  ...
  const stateExportPreProcessing = React123.useCallback((prevState, context) => {
    ...
    const shouldExportRowCount = !context.exportOnlyDirtyModels || props.paginationMeta != null || ((_b2 = (_a2 = props.initialState) == null ? void 0 : _a2.pagination) == null ? void 0 : _b2.meta) != null;
    if (!shouldExportRowCount) {
      return prevState;
    }
    return _extends({}, prevState, {
...
var paginationStateInitializer = (state, props) => {
  ...
  const paginationModel = _extends({}, getDefaultGridPaginationModel(props.autoPageSize), (_c = props.paginationModel) != null ? _c : (_b = (_a = props.initialState) == null ? void 0 : _a.pagination) == null ? void 0 : _b.paginationModel);
  throwIfPageSizeExceedsTheLimit(paginationModel.pageSize, props.signature);
  const rowCount = (_f = props.rowCount) != null ? _f : (_e = (_d = props.initialState) == null ? void 0 : _d.pagination) == null ? void 0 : _e.rowCount;
  const meta = (_j = (_i = props.paginationMeta) != null ? _i : (_h = (_g = props.initialState) == null ? void 0 : _g.pagination) == null ? void 0 : _h.meta) != null ? _j : {};
  return _extends({}, state, {
    pagination: {
      paginationModel,
      rowCount,
...
var preferencePanelStateInitializer = (state, props) => {
  var _a, _b;
  return _extends({}, state, {
    preferencePanel: (_b = (_a = props.initialState) == null ? void 0 : _a.preferencePanel) != null ? _b : {
      open: false
    }
  });
};
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const stateExportPreProcessing = React124.useCallback((prevState, context) => {
    ...
    const shouldExportPreferencePanel = !context.exportOnlyDirtyModels || ((_a2 = props.initialState) == null ? void 0 : _a2.preferencePanel) != null || preferencePanelToExport.open;
  ...
  useEnhancedEffect_default(() => {
    ...
    Object.entries(cellModesModel).forEach(([id, fields]) => {
      Object.entries(fields).forEach(([field, params]) => {
        ...
        const originalId = (_c = idToIdLookup[id]) != null ? _c : id;
...
var useGridRowEditing = (apiRef, props) => {
  ...
  useEnhancedEffect_default(() => {
    ...
    Array.from(ids).forEach((id) => {
      var _a, _b, _c;
      const params = (_a = rowModesModel[id]) != null ? _a : {
        mode: GridRowModes.View
      };
      const prevMode = ((_b = copyOfPrevRowModesModel[id]) == null ? void 0 : _b.mode) || GridRowModes.View;
      const originalId = (_c = idToIdLookup[id]) != null ? _c : id;
...
var useGridEditing = (apiRef, props) => {
  ...
  const getEditCellMeta = React127.useCallback((id, field) => {
    var _a, _b;
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    return (_b = (_a = editingState[id]) == null ? void 0 : _a[field]) != null ? _b : null;
  }, [apiRef]);
...
var useGridRows = (apiRef, props) => {
  ...
  const updateServerRows = React128.useCallback((updates, groupKeys) => {
    ...
    const cache2 = updateCacheWithNewRows({
      ...
      getRowId: props.getRowId,
      previousCache: apiRef.current.caches.rows,
      groupKeys: groupKeys != null ? groupKeys : []
    });
    throttledRowsChange({
      cache: cache2,
      throttle: false
  ...
  const getRowModels = React128.useCallback(() => {
    ...
    return new Map(dataRows.map((id) => {
      var _a;
      return [id, (_a = idRowsLookup[id]) != null ? _a : {}];
    }));
  }, [apiRef]);
  ...
  const getRowNode = React128.useCallback((id) => {
    var _a;
    return (_a = gridRowTreeSelector(apiRef)[id]) != null ? _a : null;
  }, [apiRef]);
...
var rowSelectionStateInitializer = (state, props) => {
  var _a;
  return _extends({}, state, {
    rowSelection: props.rowSelection ? (_a = getSelectionModelPropValue(props.rowSelectionModel)) != null ? _a : [] : []
  });
};
var useGridRowSelection = (apiRef, props) => {
  ...
  const expandMouseRowRangeSelection = React129.useCallback((id) => {
    var _a;
    let endId = id;
    const startId = (_a = lastRowToggled.current) != null ? _a : id;
...
var sortingStateInitializer = (state, props) => {
  var _a, _b, _c, _d;
  const sortModel = (_d = (_c = props.sortModel) != null ? _c : (_b = (_a = props.initialState) == null ? void 0 : _a.sorting) == null ? void 0 : _b.sortModel) != null ? _d : [];
  return _extends({}, state, {
    sorting: {
...
var useGridSorting = (apiRef, props) => {
  ...
  const createSortItem = React131.useCallback((col, directionOverride) => {
    ...
    if (existing) {
      const nextSort = directionOverride === void 0 ? getNextGridSortDirection((_a2 = col.sortingOrder) != null ? _a2 : props.sortingOrder, existing.sort) : directionOverride;
    ...
    return {
      field: col.field,
      sort: directionOverride === void 0 ? getNextGridSortDirection((_b2 = col.sortingOrder) != null ? _b2 : props.sortingOrder) : directionOverride
    };
  ...
  const stateExportPreProcessing = React131.useCallback((prevState, context) => {
    ...
    const shouldExportSortModel = !context.exportOnlyDirtyModels || props.sortModel != null || ((_b2 = (_a2 = props.initialState) == null ? void 0 : _a2.sorting) == null ? void 0 : _b2.sortModel) != null || sortModelToExport.length > 0;
...
function useGridDimensions(apiRef, props) {
  ...
  const headerFilterHeight = Math.floor(((_a = props.headerFilterHeight) != null ? _a : props.columnHeaderHeight) * densityFactor);
...
var useGridColumnHeaders = (props) => {
  ...
  const getColumnGroupHeaders = ({
    ...
    const firstGroupToRender = (_b = (_a = columnGroupsModel[firstColumnFieldToRender]) == null ? void 0 : _a[depth]) != null ? _b : null;
    const firstGroupIndex = rowStructure.findIndex(({
      groupId,
      columnFields
    }) => groupId === firstGroupToRender && columnFields.includes(firstColumnFieldToRender));
    const lastColumnFieldToRender = visibleColumns[lastColumnToRender - 1].field;
    const lastGroupToRender = (_d = (_c = columnGroupsModel[lastColumnFieldToRender]) == null ? void 0 : _c[depth]) != null ? _d : null;
    ...
    const leftOverflow = hiddenGroupColumns.reduce((acc, field) => {
      var _a2;
      const column = apiRef.current.getColumn(field);
      return acc + ((_a2 = column.computedWidth) != null ? _a2 : 0);
    }, 0);
...
function groupForwardedProps(props) {
  ...
  const newProps = {};
  const forwardedProps = (_a = props.forwardedProps) != null ? _a : {};
  ...
  const hydrateRowsMeta = React143.useCallback(() => {
    ...
    const calculateRowProcessedSizes = (row) => {
      ...
      if (getRowSpacing) {
        ...
        initialHeights.spacingTop = (_a2 = spacing.top) != null ? _a2 : 0;
        initialHeights.spacingBottom = (_b2 = spacing.bottom) != null ? _b2 : 0;
      }
...
var getColumnGroupsHeaderStructure = (orderedColumns, unwrappedGroupingModel, pinnedFields) => {
  const getParents = (field) => {
    var _a;
    return (_a = unwrappedGroupingModel[field]) != null ? _a : [];
  };
  ...
  for (let depth = 0; depth < maxDepth; depth += 1) {
    const depthStructure = orderedColumns.reduce((structure, newField) => {
      var _a;
      const groupId = (_a = getParents(newField)[depth]) != null ? _a : null;
...
var columnGroupsStateInitializer = (state, props, apiRef) => {
  ...
  const groupLookup = createGroupLookup((_a = props.columnGroupingModel) != null ? _a : []);
  const unwrappedGroupingModel = unwrapGroupingColumnModel((_b = props.columnGroupingModel) != null ? _b : []);
  const columnGroupsHeaderStructure = getColumnGroupsHeaderStructure(columnFields, unwrappedGroupingModel, (_c = apiRef.current.state.pinnedColumns) != null ? _c : {});
  const maxDepth = visibleColumnFields.length === 0 ? 0 : Math.max(...visibleColumnFields.map((field) => {
    var _a2, _b2;
    return (_b2 = (_a2 = unwrappedGroupingModel[field]) == null ? void 0 : _a2.length) != null ? _b2 : 0;
  }));
  return _extends({}, state, {
    columnGrouping: {
      lookup: groupLookup,
...
var useGridColumnGrouping = (apiRef, props) => {
  ...
  const handleColumnIndexChange = React146.useCallback(() => {
    var _a;
    const unwrappedGroupingModel = unwrapGroupingColumnModel((_a = props.columnGroupingModel) != null ? _a : []);
    apiRef.current.setState((state) => {
      var _a2, _b, _c;
      const orderedFields = (_b = (_a2 = state.columns) == null ? void 0 : _a2.orderedFields) != null ? _b : [];
      const pinnedColumns = (_c = state.pinnedColumns) != null ? _c : {};
  ...
  const updateColumnGroupingState = React146.useCallback((columnGroupingModel) => {
    var _a, _b, _c;
    const pinnedColumns = (_c = (_b = (_a = apiRef.current).getPinnedColumns) == null ? void 0 : _b.call(_a)) != null ? _c : {};
    const columnFields = gridColumnFieldsSelector(apiRef);
    const visibleColumnFields = gridVisibleColumnFieldsSelector(apiRef);
...
function extractColumnWidths(apiRef, options, columns) {
  ...
  columns.forEach((column) => {
    ...
    const widths = cells.map((cell) => {
      var _a2;
      return (_a2 = cell.getBoundingClientRect().width) != null ? _a2 : 0;
    });
    ...
    if (options.includeHeaders) {
      ...
      if (header) {
        ...
        const width = contentWidth + paddingWidth + ((_a = iconContainer == null ? void 0 : iconContainer.clientWidth) != null ? _a : 0) + ((_b = menuContainer == null ? void 0 : menuContainer.clientWidth) != null ? _b : 0);
...
var useGridColumnResize = (apiRef, props) => {
  ...
  const autosizeColumns = React147.useCallback(async (userOptions) => {
    ...
    const options = _extends({}, DEFAULT_GRID_AUTOSIZE_OPTIONS, userOptions, {
      columns: (_b = userOptions == null ? void 0 : userOptions.columns) != null ? _b : state.orderedFields
    });
    ...
    try {
      ...
      if (options.expand) {
        ...
        const totalWidth = visibleColumns.reduce((total, column) => {
          var _a2, _b2;
          return total + ((_b2 = (_a2 = widthByField[column.field]) != null ? _a2 : column.computedWidth) != null ? _b2 : column.width);
        }, 0);
